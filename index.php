...
<head>
	...
	<link rel="stylesheet" type="text/css" href="includes/animate/animate.css">
	<link rel="stylesheet" type="text/css" href="includes/css-hamburgers/hamburgers.min.css">
	<link rel="stylesheet" type="text/css" href="includes/animsition/css/animsition.min.css">
	<link rel="stylesheet" type="text/css" href="includes/select2/select2.min.css">
	<link rel="stylesheet" type="text/css" href="includes/daterangepicker/daterangepicker.css">
	<link rel="stylesheet" type="text/css" href="includes/slick/slick.css">
	<link rel="stylesheet" type="text/css" href="includes/lightbox2/css/lightbox.min.css">
...
<body class="animsition">
	...
	<script type="text/javascript" src="includes/animsition/js/animsition.min.js"></script>
	<script type="text/javascript" src="includes/bootstrap/js/popper.js"></script>
	<script type="text/javascript" src="includes/bootstrap/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="includes/select2/select2.min.js"></script>
	...
	<script type="text/javascript" src="includes/parallax100/parallax100.js"></script>
	<script type="text/javascript">
        $('.parallax100').parallax100();
	</script>
	<script type="text/javascript" src="includes/countdowntime/countdowntime.js"></script>
